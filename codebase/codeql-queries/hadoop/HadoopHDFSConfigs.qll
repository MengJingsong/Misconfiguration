...
predicate validHadoopHDFSConfigs(string s) {
  s in [
    ...
    "dfs.client.failover.lazy.resolved",
    ...
    "dfs.namenode.available-space-rack-fault-tolerant-block-placement-policy.balanced-space-tolerance",
    ...
    "dfs.pipeline.ecn",
    "dfs.pipeline.slownode",
    "dfs.pipeline.congestion.ratio",
    ...
    "dfs.client.rbf.observer.read.enable"
  ]
}